<template>
  ...
  >
    <button
      ...
      ref="btnEl"
      type="button"
      class="group fixed bottom-[max(1.25rem,env(safe-area-inset-bottom))] right-[max(1.25rem,env(safe-area-inset-right))] z-50 grid h-[48px] w-[48px] place-items-center rounded-full border-0 bg-[rgb(var(--color-primary-600))] text-[#fff] shadow-[0_8px_22px_rgba(0,0,0,0.18)] transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:-translate-y-[4px] hover:bg-[rgb(var(--color-primary-700))] hover:shadow-[0_12px_26px_rgba(0,0,0,0.28)] focus-visible:-translate-y-[4px] focus-visible:bg-[rgb(var(--color-primary-700))] focus-visible:shadow-[0_12px_26px_rgba(0,0,0,0.28)] focus-visible:outline-none active:-translate-y-[1px] active:scale-[0.96] motion-reduce:transition-none dark:bg-[rgb(var(--color-primary-500))] dark:shadow-[0_8px_22px_rgba(0,0,0,0.55)] dark:hover:bg-[rgb(var(--color-primary-400))] dark:focus-visible:bg-[rgb(var(--color-primary-400))]"
